...
public class Element implements Parcelable {
    ...
    protected Element(Parcel in) {
        ...
        id = in.readInt();
        emoji = in.readString();
        parent1 = in.readParcelable(Element.class.getClassLoader());
        parent2 = in.readParcelable(Element.class.getClassLoader());
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(parent1, flags);
        dest.writeParcelable(parent2, flags);
    }
